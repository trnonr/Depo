<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="Meow.Profil" %>
  ...
  <div class="w3-dropdown-hover w3-hide-small">
    ...
    <div class="w3-dropdown-content w3-card-4 w3-bar-block" style="width:300px">
     ...
     <asp:Repeater ID="rptpp" runat="server">
         <ItemTemplate>
             <a href="Default.aspx?UyeId=<%#Eval("UyeId") %>">
      ...
      <div class="w3-card-2 w3-round w3-white">
        <div class="w3-container">
         <h4 class="w3-center">Profilim</h4>
            <asp:Repeater ID="profilpp" runat="server">
                <ItemTemplate>
         <a href="Profil.aspx?UyeId=<%#Eval("UyeId") %>" title="Avatar"><img src="/Resimler/<%#Eval("Resim") %>" class="center-block" style="height:106px;width:106px" alt="Avatar"></a></a>
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i><%#Eval("Ad") %></p>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i><%#Eval("Okul") %></p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i><%#Eval("Şehir") %></p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i><%#Eval("DogumTarihi","{0:dd MMM yyyy}") %></p>
                </ItemTemplate>
                    </asp:Repeater>
